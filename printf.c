...
/**
 * _print_unsigned_int - function that prints an unsigned integer
...
/**
 * _print_string - function that prints a string from a variable argument list
 * @s: argument
 * @fd:file descriptor
...
/**
 * check - function that checks for format specifiers
 * @mym: argument list
